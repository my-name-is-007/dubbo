...
/**
 * 心跳处理器: 用来处理心跳事件, 也就是接收消息上增加了对心跳消息的处理.
 *
 * 处理 收到的心跳请求、收到的心跳响应.
 *
 * HeaderExchangeClient 通过时间轮发送心跳
 *
 * @see HeaderExchangeClient
 *
 */
public class HeartbeatHandler extends AbstractChannelHandlerDelegate {
    ...
    /**
     * 只处理 心跳事件, 非 心跳事件 直接交给 AllChannelHandler#received
     *
     * 如果心跳请求, 且需要响应, 则返回一个响应;
     * 如果是心跳响应, 则仅输出日志
     */
    @Override
