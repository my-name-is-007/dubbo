...
public class Transporters {
    ...
    /**
     * 创建服务端.
     * 根据 URL, 通过SPI 获取 Transporter(默认 NettyTransporter),
     * 然后 NettyTransporter 创建 服务端: NettyServer
     *
     * @param handlers
     * @return
    ...
    public static RemotingServer bind(URL url, ChannelHandler... handlers) throws RemotingException {
        ...
        //获取自适应 Transporter 实例，并调用实例方法, 默认是 NettyTransporter
     ...
     * 创建客户端.
     * 根据 URL, 通过SPI 获取 Transporter(默认 NettyTransporter),
     * 然后 NettyTransporter 创建 客户端: NettyClient
     *
     * @param url
     * @param handlers
     * @return
